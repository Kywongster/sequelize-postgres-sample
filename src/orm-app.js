...
const port = 3001;
// pg imports
const { getSneakersByBrandId, createBrand, getLargestBrandId } = require('./database/pg');
// Sequelize ORM Imports
const { init, getBrands } = require('./database/orm');
...
app.get('/', async (req, res) => {
  // The next line is only required the first time the app is ran.
  await init();
